...
public class horizontal_platform_mover : MonoBehaviour {

	enum movementDirections {left = -1, right = 1};
	...
	void Start () {
		...
		if (finalPosition.x - startingPosition.x < 0)
			moveDirection = (int)movementDirections.left;
		else
			moveDirection = (int)movementDirections.right;
